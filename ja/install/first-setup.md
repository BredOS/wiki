...
- Bakeryは、完了していない限り、起動時に自動的に起動します。 また、再起動せずにデスクトップリンクを開始することもできます。 オンラインまたはオフラインのインストールの間のセットアップの選択を開始します。 再起動せずに起動するデスクトップのショートカットもあります。 セットアップを開始するには、オンラインまたはオフラインのインストールを選択します。 再起動せずに起動するデスクトップのショートカットもあります。 セットアップを開始するには、オンラインまたはオフラインのインストールを選択します。
