...
# 2. RKNN or Rocket driver, the differences
...
## 2.1 RKNN driver
The RKNN driver is packaged with the BSP kernel 6.1. If you have the mainline kernel installed, you must use the Rocket driver or install the package `linux-rockchip-rkr3` and boot this kernel instead. 
