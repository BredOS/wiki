...
RKNN 驱动程序被打包使用 BSP 内核6.1。 If you have the mainline kernel installed, you must use the Rocket driver or install the package `linux-rockchip-rkr3` and boot this kernel instead.
