...
> This article is intended for SBCs based on an ARMv9 System-on-Chip, such as the Cix Pi 81x0. ARMv8 SoCs do support the execution of 32-bit code. For ARMv8 SBCs, use box64 instead!
{.is-info}
