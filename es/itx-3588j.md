...
A diferencia de otros SBCs, el adaptador Bluetooth _no_ está conectado a /dev/ttyS6, sino a /dev/ttyS9. Si tienes problemas para activar el Bluetooth, sigue este [guide](/en/itx-3588j/Bluetooth-Fix).
